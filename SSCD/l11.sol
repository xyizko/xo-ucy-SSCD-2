...
contract SimpleStorage {
    ...
    // Custom type - struct which is being defined below
    struct Killa{
        uint256 number;
        string weapon;
    }
    ...
    // Mapping set which is like a dictrionary 

    mapping(string => uint256) public nameToWeapon;

    function addKilla(uint256 _number, string memory _weapon) public{
        listOfKillaz.push(Killa(_number, _weapon));
